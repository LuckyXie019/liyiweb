...
<body class="page woocommerce-checkout woocommerce-page">
	<div class="body-wrapper theme-clearfix">
									...
									<div class="widget-1 widget-first widget nav_menu-4 widget_nav_menu">
										<div class="widget-inner">
											<ul id="menu-my-account" class="menu">
												...
												<li class="menu-cart">
													<a class="item-link" href="<%=basePath%>/liyi_sj/stage/register.jsp">
		...
		<div class="container">
			<div class="row" style="background-color: white;margin:40px  0px 40px 0px;padding-bottom:100px;">
				<div id="contents" role="main" class="main-page  col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 70px;">
				<div class="col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
				<div style="float: left;">
				<img src="image/successful.jpg">	
				</div>
				<div style="float: left;margin-left: 50px;">
				<p style="margin-top: 50px;">
				<span style="font-size:20px;">恭喜你,购买成功!</span>
				</p>
				<p  style="font-size:14px;color: gray">订单编号:<span id="orderid"></span></p>
				<p  style="font-size:14px;color: gray">购买金额:<span id="price"></span></p>
				<p  style="font-size:14px;color: gray">购买时间:<span id="ordertime"></span></p>
				
		 <div style="margin-top: 40px;">
		<a href="index.jsp" type="button" class="btn btn-info" style="margin-right: 30px;">返回首页</a>			
		<a href="cart.jsp" type="button" class="btn btn-danger">继续购买</a>	
		</div>
				</div>
				</div>
			</div>
	...
	<script>
		...
		if(type==4&&userid!=''){
		    ...
		    $("#price").html(price);
		    $("#ordertime").html(Date.prototype.getLongDate(new Date()));
