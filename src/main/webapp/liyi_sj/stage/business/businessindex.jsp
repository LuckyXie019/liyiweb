...
<body class="page woocommerce-checkout woocommerce-page" style="background-color: #f1f0ec;">
	<div class="body-wrapper theme-clearfix">
		<header id="header" class="header header-style1">
			...
			<!-- 大图 -->	
			<a href="../simple_product.html"><img src="../image/store1.jpg" class="img-responsive"/></a>
            ...
            doData("sj_commodity/getmecommstorePage", model1, function (data) {
                for (var i = 0; i < data.obj.length; i++) {
                    ...
                    $("#commdiotydiv").append("<li class=\"item col-lg-3 col-md-3 col-sm-4 col-xs-6 post-255 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-home-appliances product_cat-vacuum-cleaner product_brand-apoteket first instock sale featured shipping-taxable purchasable product-type-simple\">\n" +
                        ...
                        "            <a href=\"javascript:void(0);\" onclick=\"xiajia('"+data.obj[i].comid+"','"+data.obj[i].commname+"')\"  class=\"pull-right\" style=\"color: red;text-decoration: underline;\">宝贝下架</a>\n" +
                        "            </p>\n" +
                        "            </div>\n" +
                        "            </div>\n" +
                        "            </div>\n" +
