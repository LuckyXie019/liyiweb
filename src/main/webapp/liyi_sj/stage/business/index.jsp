...
<body class="page woocommerce-checkout woocommerce-page" style="background-color: #f1f0ec;">
<div class="body-wrapper theme-clearfix">
    <header id="header" class="header header-style1">
        ...
        <div style="background-color: #f5f5f5;">
            <ol class="breadcrumb" style="text-align: center;padding:10px 0px 10px 0px;">
                <li><a id="storename" href="#" style="color:gray;">XX旗舰店</a>
                    ...
                    <span id="collection-sp" style="color: gray;"><i class="glyphicon glyphicon-star-empty" style="line-height: 10px;color: red;"></i>
                        <a href="Javascript:void(0);">收藏店铺</a>
  						</span>
            </ol>
        </div>
    </header>
    ...
    <!-- 大图 -->
    <a href="../simple_product.jsp"><img src="../image/store1.jpg" class="img-responsive"/></a>
    <img src="../image/store2.jpg" class="img-responsive"/>
    <img src="../image/rt.jpg">
    <!-- 中间 -->
    <div class="container" style="padding:0px;margin-top: 50px;margin-bottom: 70px;">
        <div class="row">
            <div id="contents" role="main" class="main-page  col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:0px;">
                <ul id="commdiotydiv" class="products-loop row grid clearfix" style="background-color: white;padding-top: 50px;">
...
<script>
    ...
    doData("sj_store/getMe",storeobj,function (data) {
        ...
        $("#storeye").attr("href","<%=basePath%>/liyi_sj/stage/business/index.jsp?storeid="+data.obj.id);
        $("#storecomm").attr("href","<%=basePath%>/liyi_sj/stage/business/allbaby.jsp?storeid="+data.obj.id)
    })
        ...
        doData("sj_commodity/getmecommstorePage", model1, function (data) {
            for (var i =0; i < data.obj.length; i++){
                ...
                $("#commdiotydiv").append("<li class=\"item col-lg-3 col-md-3 col-sm-4 col-xs-6 post-255 product type-product status-publish has-post-thumbnail product_cat-electronics product_cat-home-appliances product_cat-vacuum-cleaner product_brand-apoteket first instock sale featured shipping-taxable purchasable product-type-simple\">\n" +
                    ...
                    "sizes=\"(max-width: 300px) 100vw, 300px\" style=\"margin-top:10px\" />\n" +
                    "</div>\n" +
                    "</a>\n" +
                    ...
                    "<h5>\n" +
                    "<a href=\"simple_product.html\">"+data.obj[i].commname+"</a>\n" +
                    "</h5>\n" +
