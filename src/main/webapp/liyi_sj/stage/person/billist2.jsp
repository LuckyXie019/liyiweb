...
<body class="page has-right-sidebar has-right-product-sidebar">
			...
			<div class="col-main">
				<div class="main-wrap">
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">我的账单</strong></div>
					</div>
					<hr>
					...
					<div class="order-time">
						...
						<div class="show-input">
							<select onchange="selectmingxi()" id="number1" class="am-selected" data-am-selected>
								<option value="0">今天</option>
								<option value="7" selected="">最近一周</option>
								<option value="30">最近一个月</option>
								<option value="90">最近三个月</option>
								<option class="date-trigger" value="1">全部账单</option>
							</select>
						</div>
                          <div class="clear"></div>
					</div>
					...
					<table width="100%">
						...
						<thead>
							<tr style="border-bottom: 1px solid gainsboro;">
								...
								<th class="name">名称</th>
								<th class="name" style="width: 20%">类型</th>
						...
						<tbody id="mingxidiv">
							<%--<tr>--%>
								...
								<%--</td>--%>
								<%--<td class="operation">--%>
									<%--<button class="am-btn am-btn-secondary">删除</button>--%>
								<%--</td>--%>
							<%--</tr>--%>
							...
							<%--<tr>--%>
								...
								<%--</td>--%>
								<%--<td class="operation">--%>
									<%--<button class="am-btn am-btn-secondary">查看账单</button>--%>
								<%--</td>--%>
							<%--</tr>--%>
						</tbody>
					</table>
					...
					<nav style="margin-top:90px;" class="">
						<ul class="pager">
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="billist2.jsp">我的账单</a></li>
	...
	<script>
        ...
        if(userid!='') {
			...
			mingxi(count,limit,start,newtime,number,"mingxidiv");
        ...
        function mingxi(count,limit,start,newtime,number,orderdiv) {
			var zhangdanobj=new Object();
			zhangdanobj.u_id=userid;
			zhangdanobj.number=number;
			zhangdanobj.newtime=newtime;
			zhangdanobj.limit=limit;
			zhangdanobj.start=(count-1)*limit;
			doData("sjyh_order/fandbyPageorder2",zhangdanobj,function (data) {
                ...
                for (var i=0;i<data.obj.length;i++){
					...
					$("#"+orderdiv).append("<tr>\n" +
                        ...
                        "\n" +
                        "<td class=\"amount\">\n" +
                        "<span class=\"amount-pay\">+ "+realityjia+"</span>\n" +
                        "</td>\n" +
                        "<td class=\"operation\">\n" +
                        "<a style=\"color:white\" href=\"<%=basePath%>/liyi_sj/stage/person/orderinfo2.jsp?orderid="+data.obj[i].id+"\" class=\"am-btn am-btn-secondary\">账单详情</a>\n" +
                        "</td>\n" +
                        "</tr>")
					}else{
