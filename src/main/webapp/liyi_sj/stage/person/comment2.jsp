...
<head>	
	...
	<link href="../AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="../personcss/cmstyle.css" rel="stylesheet" type="text/css">
...
<body class="page has-right-sidebar has-right-product-sidebar">
					...
					<div class="user-comment">
						...
						<div class="am-tabs am-tabs-d2 am-margin" data-am-tabs>
							...
							<div class="am-tabs-bd">
								<div class="am-tab-panel am-fade am-in am-active" id="tab1">
									...
									<div class="comment-main">
										<div class="comment-top">
											...
											<div class="th th-item" style="width:15%;text-align: center;">
										...
										<%--<div class="comment-list">--%>
											<%--<ul class="item-list">--%>
												<%--<li class="td td-item">--%>
													<%--<div class="item-pic">--%>
														<%--<img src="../image/4980b.jpg" class="itempic">--%>
													<%--</div>--%>
												<%--</li>--%>
												...
												<%--<li class="td td-comment">--%>
													<%--<div class="item-title" style="text-align:center;">--%>
														<%--<div class="item-name">--%>
															<%--<a href="../simple_product.jsp">--%>
																<%--<p class="item-basic-info">天气风暴预报瓶--%>
																	<%--&nbsp;&nbsp;<span>颜色：蓝色</span>--%>
																<%--</p>--%>
															<%--</a>--%>
														<%--</div>--%>
													...
													<%--<div class="item-info" style="text-align:center;">--%>
														<%--<div>--%>
															<%--<p class="info-little"><a id="delcomment" href="javascript:void(0);">删除</a></p>--%>
														<%--</div>--%>
													<%--</div>--%>
												<%--</li>--%>
											<%--</ul>--%>
								...
								<%--<div class="am-tab-panel am-fade" id="tab5"><div class="comment-main">--%>
										<%--<div class="comment-list">--%>
											<%--<ul class="item-list">--%>
	...
	<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="padding-top: 5%;">
		<div class="modal-dialog modal-sm" role="document">
			...
			<div class="modal-content" style="height:150px;width: 50%;margin-left: 30%;">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" style="font-size: 20px;">&times;</span></button>
				<div style="padding:30px 0px 20px 0px;">
					<p style="text-align: center;font-size: 14px;">是否删除该条评论?</p>
				</div>
				<center><button type="button" onclick="delete2()" class="btn btn-xs btn-info" data-dismiss="modal" style=";margin-top:30px;padding:5px 15px;">是</button>
					<button type="button" class="btn btn-xs btn-info" data-dismiss="modal" style=";margin-top:30px;padding:5px 15px;margin-left: 20px;">否</button>
				</center>
			</div>
		</div>
	</div>
	...
	<script>
        ...
        if(userid!='') {
			...
			pageevaluation(count,start,limit);
        ...
        function pageevaluation(count,start,limit) {
            var evobj=new Object();
            evobj.uid=userid;
            evobj.start=(count-1)*limit;
            evobj.limit=limit;
            doData("sj_evaluation/usergetevaluation",evobj,function (data) {
                ...
                for (var i=0;i<data.obj.length;i++) {
                    ...
                    $("#pingjiadiv").append("<div class=\"comment-list\">\n" +
                        "<ul class=\"item-list\">\n" +
                        "<li class=\"td td-item\">\n" +
                        "<div class=\"item-pic\">\n" +
                        "<img src=\"<%=basePath%>/uploadfiles/"+data.obj[i].styleImage+"\" class=\"itempic\">\n" +
                        "</div>\n" +
                        "</li>\n" +
                        "\n" +
                        "<li class=\"td td-comment\">\n" +
                        ...
                        "<p class=\"item-basic-info\">"+data.obj[i].commname+"\n" +
                        "&nbsp;&nbsp;<span>颜色："+data.obj[i].stylename+"</span>\n" +
                        "</p>\n" +
                        "</a>\n" +
                        "</div>\n" +
                        "</div>\n" +
                        ...
                        "<div class=\"item-info\">\n" +
                        "<div>\n" +
                        "<p class=\"info-time\">"+data.obj[i].assesstime+"</p>\n" +
                        "</div>\n" +
                        "</div>\n" +
                        "\n" +
                        "<div class=\"item-info\" style=\"text-align:center;\">\n" +
                        "<div>\n" +
                        "<p onclick=\"deleteevaluation('"+data.obj[i].id+"')\" class=\"info-little\"><a id=\"delcomment\" href=\"javascript:void(0);\">删除</a></p>\n" +
                        "</div>\n" +
                        "</div>\n" +
                        "</li>\n" +
                        "</ul>\n" +
