...
<head>	
	...
	<link href="../AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="../personcss/cpstyle.css" rel="stylesheet" type="text/css">
...
<body class="page has-right-sidebar has-right-product-sidebar">
											...
											<div class="minicart-padding">
												...
												<div class="cart-checkout">
													...
													<div class="cart-links clearfix">
														<div class="cart-link">
															<a href="<%=basePath%>/liyi_sj/stage/cart.jsp" title="Cart">查看购物车</a>
														</div>
				...
				<div class="main-wrap">
					...
					<div class="user-coupon">
						...
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">优惠券</strong></div>
						</div>
						<hr/>
						...
						<div class="am-tabs-d2 am-tabs  am-margin" data-am-tabs>
							...
							<ul class="am-avg-sm-2 am-tabs-nav am-nav am-nav-tabs">
								<li onclick="wei()" class="am-active"><a href="#tab1">可用优惠券</a></li>
								<li onclick="shixiao()"><a href="#tab2">已用/失效优惠券</a></li>

							</ul>

							<div class="am-tabs-bd">
								<div class="am-tab-panel am-fade am-in am-active" id="tab1">
									<div id="discountdiv" class="coupon-items">
											...
											<%--<div class="coupon-list">--%>
												<%--<div class="c-type">--%>
													...
													<%--<div class="c-limit">--%>
														<%--【消费满&nbsp;95元&nbsp;可用】--%>
													<%--</div>--%>
													<%--<div class="c-time"><span>使用期限</span>永久有效</div>--%>
												...
												<%--<div class="c-msg">--%>
													<%--<div class="c-range">--%>
														<%--<div class="range-all">--%>
															<%--<a href="#" class="range-item">--%>
																<%--<span class="label">店&nbsp;铺：</span>--%>
																<%--<span class="txt">35730144</span>--%>
															<%--</a>--%>
														<%--</div>--%>
													<%--</div>--%>
													<%--<div class="op-btns">--%>
														<%--<a href="#" class="btn"><span class="txt">进入店铺使用</span><b></b></a>--%>
													<%--</div>--%>
												<%--</div>--%>
											<%--</div>--%>
										<%--</div>--%>
										<%--<div class="coupon-item coupon-item-yf">--%>
											<%--<div class="coupon-list">--%>
												...
												<%--<div class="c-msg">--%>
													...
													<%--</div>--%>
													<%--<div class="op-btns">--%>
														<%--<a href="#" class="btn"><span class="txt">购买商品使用</span><b></b></a>--%>
													<%--</div>--%>
												<%--</div>--%>
											<%--</div>--%>
										<%--</div>--%>
								...
								<div class="am-tab-panel am-fade" id="tab2">
									<div id="discountdiv2" class="coupon-items">
										<%--<div class="coupon-item coupon-item-d">--%>
											<%--<div class="coupon-list">--%>
												<%--<div class="c-type">--%>
													<%--<div class="c-class">--%>
												...
												<%--<li class="td td-usestatus ">--%>
													<%--<div class="item-usestatus ">--%>
														<%--<span><img src="../image/gift_stamp_31.png"></span>--%>
													<%--</div>--%>
												<%--</li>												--%>
											<%--</div>--%>
										<%--</div>--%>
										<%--<div class="coupon-item coupon-item-yf">--%>
											<%--<div class="coupon-list">--%>
												...
												<%--<li class="td td-usestatus ">--%>
													<%--<div class="item-usestatus ">--%>
														<%--<span><img src="../image/gift_stamp_21.png"></span>--%>
													<%--</div>--%>
												<%--</li>--%>
											<%--</div>--%>
										<%--</div>--%>
			...
			<aside class="menu">
				<ul>
					...
					<li class="person">
						...
						<ul>
							<li class="active"> <a href="coupon2.jsp">优惠券 </a></li>
	...
	<script>
        ...
        function getdiscount(status,sdiv) {
            var disobj=new Object();
            disobj.u_id=userid;
            disobj.status=status;
            $("#"+sdiv).html("");
            doData("sj_discount/getdiscountview",disobj,function (data) {

                for (var i=0;i<data.obj.length;i++) {

                    if (data.obj[i].status=="未失效"){

                        $("#"+sdiv).append("<div class=\"coupon-item coupon-item-d\">\n" +
                            "<div class=\"coupon-list\">\n" +
                            "<div class=\"c-type\">\n" +
                            "<div class=\"c-class\">\n" +
                            "<strong>购物券</strong>\n" +
                            "</div>\n" +
                            "<div class=\"c-price\">\n" +
                            "<strong>￥"+data.obj[i].amount+"</strong>\n" +
                            "</div>\n" +
                            "<div class=\"c-limit\">\n" +
                            "【消费满&nbsp;"+data.obj[i].require1+"元&nbsp;可用】\n" +
                            "</div>\n" +
                            "<div class=\"c-time\"><span>使用期限</span>永久有效</div>\n" +
                            "<div class=\"c-type-top\"></div>\n" +
                            "\n" +
                            ...
                            "<a href=\"#\" class=\"range-item\">\n" +
                            "<span class=\"label\">店&nbsp;铺：</span>\n" +
                            "<span class=\"txt\">"+data.obj[i].storename+"</span>\n" +
                            "</a>\n" +
                            "</div>\n" +
                            "</div>\n" +
                            "<div class=\"op-btns\">\n" +
                            "<a href=\"<%=basePath%>/liyi_sj/stage/business/index.jsp?storeid="+data.obj[i].s_id+"\" class=\"btn\"><span class=\"txt\">进入店铺使用</span><b></b></a>\n" +
                            "</div>\n" +
                            "</div>\n" +
                            "</div>\n" +
                            "</div>");
                        ...
                        $("#"+sdiv).append("<div class=\"coupon-item coupon-item-d\">\n" +
                            ...
                            "【消费满&nbsp;"+data.obj[i].require1+"元&nbsp;可用】\n" +
                            "</div>\n" +
                            "<div class=\"c-time\"><span>使用效果</span>"+data.obj[i].status+"</div>\n" +
                            "<div class=\"c-type-top\"></div>\n" +
                            "\n" +
                            "<div class=\"c-type-bottom\"></div>\n" +
                            "</div>\n" +
