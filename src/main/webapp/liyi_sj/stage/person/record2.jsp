...
<body class="page has-right-sidebar has-right-product-sidebar">
	<div class="body-wrapper theme-clearfix">
		...
		<div class="center">
			<div class="col-main">
				<div id="orderdiv" class="main-wrap">
					<!--标题 -->
						...
						<%--<div class="record-aside">--%>
							...
							<%--<div class="item-info">--%>
								<%--<div class="item-ordernumber">--%>
									<%--<span class="info-title">订单编号：</span><a>147478464147</a>--%>
								<%--</div>--%>

								<%--<div class="item-time">--%>
									<%--<span style="width: 95px" class="info-title">申请退款时间：</span><span class="time">2015-12-16&nbsp;17:07</span>--%>
								<%--</div>--%>
...
<aside class="menu">
	...
	<script>
        ...
        if(userid!='') {
			...
			orobj.id=orderid;
			doData("/sjyh_order/ordersviewgetMe2",orobj,function (data) {

                data.obj[0].refundtime=Date.prototype.getLongDate(data.obj[0].refundtime);
				data.obj[0].succeedtime=Date.prototype.getLongDate(data.obj[0].succeedtime);
                var reality=data.obj[0].reality;
                reality=reality.toFixed(2);

                if (data.obj[0].refundresult=="退款关闭") {

                    $("#orderdiv").append("<div class=\"am-cf am-padding\">\n" +
                        "<div class=\"am-fl am-cf\"><strong class=\"am-text-danger am-text-lg\">钱款去向</strong></div>\n" +
                        "</div><hr/>\n" +
                        "<div class=\"comment-list\">\n" +
                        "<div class=\"record-aside\">\n" +
                        ...
                        "<div class=\"item-title\">\n" +
                        "<div class=\"item-name\">\n" +
                        "<a href=\"../simple_product.html?comid=" + data.obj[0].c_id + "&type=2\">\n" +
                        ...
                        "\n" +
                        "<div class=\"item-time\">\n" +
                        "<span style=\"width: 95px\" class=\"info-title\">申请退款时间：</span><span class=\"time\">" + data.obj[0].refundtime + "</span>\n" +
                        "</div>\n" +
                        "\n" +
                        "</div>\n" +
                        "<div class=\"clear\"></div>\n" +
                        ...
                        "                                <em class=\"u-progress-stage-bg\"></em>\n" +
                        "                                <i class=\"u-stage-icon-inner\">1<em class=\"bg\"></em></i>\n" +
                        "                                <p class=\"stage-name\">发起退款 </p>\n" +
                        "                                <p class=\"stage-name\">"+data.obj[0].refundtime+"</p>\n" +
                        "                            </span>\n" +
                        "<span class=\"step-2 step\">\n" +
                        "                                <em class=\"u-progress-stage-bg\"></em>\n" +
                        "                                <i class=\"u-stage-icon-inner\">2<em class=\"bg\"></em></i>\n" +
                    ...
                    $("#orderdiv").append("<div class=\"am-cf am-padding\">\n" +
                        ...
                        "<i class=\"u-stage-icon-inner\">1<em class=\"bg\"></em></i>\n" +
                        "<p class=\"stage-name\">卖家退款 </p>\n" +
                        "<p class=\"stage-name\">" + data.obj[0].succeedtime + "</p>\n" +
                        "</span>\n" +
                        "<span class=\"step-2 step\">\n" +
                        "<em class=\"u-progress-stage-bg\"></em>\n" +
                        "<i class=\"u-stage-icon-inner\">2<em class=\"bg\"></em></i>\n" +
                        ...
                        "<i class=\"u-stage-icon-inner\">3<em class=\"bg\"></em></i>\n" +
                        "<p class=\"stage-name\">退款成功</p>\n" +
                        "<p class=\"stage-name\">"+succeedtime+"</p>\n" +
                        "</span>\n" +
                        "<span class=\"u-progress-placeholder\"></span>\n" +
                        "</div>\n" +
                        "<div class=\"u-progress-bar total-steps-2\">\n" +
