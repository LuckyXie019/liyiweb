			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">绑定邮箱</strong></div>
					</div>
					<hr/>
					<!--进度条-->
...
<aside class="menu">
				<ul>
					...
					<li class="person">
						...
						<ul>
							<li> <a href="information2.html">个人信息</a></li>
							<li> <a href="safety2.html">安全设置</a></li>
							<li> <a href="address2.html">收货地址</a></li>
						</ul>
					</li>
					...
					<li class="person">
						...
						<ul>
							<li> <a href="order2.html">我的订单</a></li>
						</ul>
					</li>
					...
					<li class="person">
						...
						<ul>
							<li> <a href="change2.html">退款/售后管理</a></li>
							<li> <a href="#">投诉管理</a></li>
							<li> <a href="#">举报管理</a></li>
						</ul>
					</li>
					<li class="person">
						...
						<ul>
							<li> <a href="coupon2.html">优惠券 </a></li>
							<li> <a href="billist2.html">我的账单</a></li>
							<li> <a href="integral2.html">我的积分</a></li>
						</ul>
					</li>
