...
<head>	
	...
	<link href="../AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="../personcss/refstyle.css" rel="stylesheet" type="text/css">
			...
			<div class="col-main">
				<div class="main-wrap" style="padding-bottom: 40px;">
					...
					<div class="m-progress">
						...
						<div id="orderinform" class="refund-aside">
							<%--<div class="item-pic">--%>
								<%--<a href="#" class="J_MakePoint">--%>
									<%--<img src="../image/302b.jpg" class="itempic">--%>
								<%--</a>--%>
							<%--</div>--%>
							...
							<%--<div class="item-info">--%>
								<%--<div class="item-ordernumber">--%>
									<%--<span class="info-title">订单编号：</span><a>15287700740261307486556021</a>--%>
								<%--</div>--%>
								...
								<%--<div class="item-pay-logis">--%>
									<%--<span class="info-title">优&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;惠：</span><span class="price">0.00元</span>--%>
								<%--</div>--%>
								<%--<div class="item-amountall">--%>
									<%--<span class="info-title">总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：</span><span class="amountall">19.88元</span>--%>
								<%--</div>--%>
								<%--<div class="item-time">--%>
						...
						<div class="refund-main">
							<div class="item-comment">
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<select id="refundstatus" data-am-selected="">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<select id="reason" data-am-selected="">
											<option value="不想要了" selected>请选择退款原因</option>
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="refund-money" readonly="readonly" placeholder="">
									</div>
								</div>
								<div class="am-form-group">
									<label  class="am-form-label">退款说明<span>（可不填）</span></label>
									<div class="am-form-content">
										<textarea id="explain" placeholder="请输入退款说明"></textarea>
									</div>
								</div>
							...
							<div class="info-btn">
								<div onclick="tuikuanbtn()" class="am-btn am-btn-danger">提交申请</div>
							</div>
						</div>
					</div>
					<div class="clear"></div>
	...
	<script>
        ...
        if(userid!=''){
            ...
            doData("/sjyh_order/ordersviewgetMe",orderobj,function (data) {
                ...
                $("#refund-money").val(realityjia);
				$("#orderinform").append("<div class=\"item-pic\">\n" +
                    "<a href=\"<%=basePath%>/liyi_sj/stage/simple_product.jsp?comid="+data.obj[0].c_id+"&type=2\" class=\"J_MakePoint\">\n" +
                    "<img src=\"<%=basePath%>/uploadfiles/"+data.obj[0].styleImage+"\" class=\"itempic\">\n" +
                    "</a>\n" +
                    "</div>\n" +
                    "\n" +
                    "<div class=\"item-title\">\n" +
                    ...
                    "<div class=\"item-info\">\n" +
                    "<div class=\"item-ordernumber\">\n" +
                    "<span class=\"info-title\">订单编号：</span><a>"+data.obj[0].id+"</a>\n" +
                    "</div>\n" +
                    "<div class=\"item-price\">\n" +
                    "<span class=\"info-title\">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span><span class=\"price\">"+commprice+"元</span>\n" +
                    "<span class=\"number\">×"+data.obj[0].goodsnumber+"</span><span class=\"item-title\">(数量)</span>\n" +
                    "</div>\n" +
                    "<div class=\"item-amount\">\n" +
                    "<span class=\"info-title\">小&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：</span><span class=\"amount\">"+pricejia+"元</span>\n" +
                    "</div>\n" +
                    "<div class=\"item-pay-logis\">\n" +
                    "<span class=\"info-title\">优&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;惠：</span><span class=\"price\">"+(pricejia-realityjia)+"元</span>\n" +
                    "</div>\n" +
                    "<div class=\"item-amountall\">\n" +
                    "<span class=\"info-title\">总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：</span><span class=\"amountall\">"+realityjia+"元</span>\n" +
                    "</div>\n" +
                    "<div class=\"item-time\">\n" +
                    "<span class=\"info-title\">成交时间：</span><span class=\"time\">"+data.obj[0].ordertime+"</span>\n" +
                    "</div>\n" +
                    "\n" +
                    "</div>\n" +
                    "<div class=\"clear\"></div>")
        ...
        function tuikuanbtn() {
			var o_id=getURLParamValue("orderid");
			...
			refundobj.o_id=o_id;
			refundobj.refundstatus=refundstatus;
			refundobj.reason=reason;
			refundobj.explains=explain;
			refundobj.money=money;
			refundobj.u_id=userid;
			refundobj.refundtime="";
			refundobj.refundresult="退款中";
			alert(o_id+","+refundstatus+","+money+","+reason+","+explain);
			doData("yh_refund/add",refundobj,function (data) {
				if(data.code>0){
				    var orobj=new Object();
				    orobj.status="退款中";
					orobj.id=getURLParamValue("orderid");
				    doData("sjyh_order/edit",orobj,function (data) {
				        if(data.code>0){
				            window.location.href="<%=basePath%>/liyi_sj/stage/person/change2.jsp";
				        }
                    })
