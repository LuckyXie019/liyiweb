...
<head>	
	...
	<link href="../AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="../personcss/footstyle.css" rel="stylesheet" type="text/css">
</head>
							...
							<div class="goods-box first-box">
								<div class="goods-pic">
									<div class="goods-pic-box">
										<a class="goods-pic-link" target="_blank" href="../simple_product.jsp">
											<img src="../image/749b.jpg" class="goods-img"></a>
									</div>
								...
								<div class="goods-attr">
									<div class="good-title">
										<a class="title" href="../simple_product.jsp" target="_blank">璀璨心动满钻手链表</a>
									</div>
									...
									<div class="goods-num">
										<div class="match-recom">
											<a href="../shop.jsp" class="match-recom-item">找相似</a>
											<a href="../shop.jsp" class="match-recom-item">找搭配</a>
											<i><em></em><span></span></i>
										</div>
									</div>
								</div>
