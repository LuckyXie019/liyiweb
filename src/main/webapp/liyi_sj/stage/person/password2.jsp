			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">修改密码</div>
					</div>
					<hr/>
					<!--进度条-->
					...
					<form class="am-form am-form-horizontal">
						...
						<div class="info-btn">
							<div onclick="passwordbtn()" class="am-btn am-btn-danger">保存修改</div>
						</div>
...
<aside class="menu">
	...
	<script>
        ...
        function passwordbtn() {
			...
			if (oldpassword!="") {
			    up.password=oldpassword;
			    up.id=userid;
			    doData("sj_information/yanzheng",up,function (data) {
			       if(data.obj[0]!=undefined) {
                       ...
                       if (newpassword != "" && confirmpassword != "") {
                           ...
                           if (newpassword == confirmpassword) {
                               ...
                               doData("sj_information/edit",up,function (data) {
								   if(data.code>0){
