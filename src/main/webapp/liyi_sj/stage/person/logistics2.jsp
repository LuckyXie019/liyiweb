...
<head>	
	...
	<link href="../AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="../personcss/lostyle.css" rel="stylesheet" type="text/css">
</head>
				...
				<div class="main-wrap">
					<div class="user-logistics">
						...
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">物流跟踪</strong></div>
						</div>
						<hr/>
						<div class="package-title">
							<div class="m-item">
								<div style="width: 10%;height: 10%" class="item-pic">
									<img id="orderimage" src=""  class="itempic J_ItemImg">
								</div>
								<div class="item-info">
									<p class="log-status">订单状态:<span id="status"></span> </p>
									<p id="logisname">承运公司：天天物流</p>
									<p id="logisnumber">快递单号：373269427868</p>
	...
	<script>
        ...
        if(userid!='') {
            ...
            doData("sjyh_order/ordersviewgetMe",orobj,function (data) {
                $("#orderimage").attr("src","<%=basePath%>/uploadfiles/"+data.obj[0].styleImage);
                $("#status").html(data.obj[0].status);
				$("#logisname").html("承运公司:"+data.obj[0].logisname);
				$("#logisnumber").html("快递单号:"+data.obj[0].logisticsnumber)
