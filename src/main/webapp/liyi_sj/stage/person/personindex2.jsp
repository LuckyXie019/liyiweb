...
<head>	
	...
	<link href="../AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css">
		...
		<link href="../personcss/systyle.css" rel="stylesheet" type="text/css">
</head>
			...
			<div class="col-main">
				<div class="main-wrap">
						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									<div id="userinformation" class="m-baseinfo">

									</div>
									<div class="m-right">
										<div class="m-new">
											<a href="news2.jsp"><i class="am-icon-bell-o"></i>消息</a>
										</div>
										<div class="m-address">
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="order2.jsp">全部订单</a>
								</div>
								<ul>
									<li><a href="order2.jsp"><i><img src="../image/send.png"/></i><span>待发货<em id="huonumber1" class="m-num">1</em></span></a></li>
									<li><a href="order2.jsp"><i><img src="../image/receive.png"/></i><span>待收货<em id="huonumber2" class="m-num"></em></span></a></li>
									<li><a href="order2.jsp"><i><img src="../image/comment.png"/></i><span>待评价<em id="huonumber3" class="m-num">3</em></span></a></li>
									<li><a href="change2.jsp"><i><img src="../image/refund.png"/></i><span>退换货<em id="huonumber4" class="m-num"></em></span></a></li>
									<li></li>
								</ul>
							</div>
							<!--九宫格-->
							<div class="user-patternIcon">
								...
								<ul>
									<a href="../shop.jsp"><li class="am-u-sm-4"><i class="am-icon-shopping-basket am-icon-md"></i><img src="../image/3260b.jpg"/><p>购物车</p></li></a>
									<a href="../collection.jsp"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="../image/1231.jpg"/><p>我的收藏</p></li></a>
									<a href="../index.jsp"><li class="am-u-sm-4"><i class="am-icon-gift am-icon-md"></i><img src="../image/1291.png"/><p>为你推荐</p></li></a>
									<a href="comment2.jsp"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="../image/306b.jpg"/><p>好评宝贝</p></li></a>
									<a href="foot2.jsp"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="../image/98c.jpg"/><p>我的足迹</p></li></a>                                                                        
								</ul>
							</div>
							<!--物流 -->
								...
								<div class="s-content">
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-pic">
												<a href="../simple_product.jsp" class="s-pic-link">
													<img src="../image/129.png"  title="永生花" class="s-pic-img s-guess-item-img">
												</a>
											</div>
											...
											<div class="s-title"><a href="../simple_product.jsp">永生花</a></div>
					...
					<div class="wrap-right">					
						<!--新品 -->
						<div class="new-goods">
							<div class="s-bar" style="color: white;font-weight: 600;">
								<i class="s-icon"></i>今日好店
							</div>
							<div id="commxinpin" class="new-goods-info">
						...
						<div class="new-goods">
							...
							<%--<div class="new-goods-info">--%>
								<%--<a class="shop-info" href="../simple_product.jsp" target="_blank">--%>
									<%--<div >--%>
	...
	<script>
        ...
        if(userid!=''){
			...
			doData("sj_information/getMe",userobj,function (data) {
				...
				$("#userinformation").append("<a href=\"information2.jsp\">\n" +
                    "<img src=\"<%=basePath%>/uploadfiles/"+data.obj.avatar+"\">\n" +
                    "</a>\n" +
                    "<em class=\"s-name\">("+data.obj.nickname+")<span class=\"vip1\">\n" +
                    "<div class=\"s-prestige am-btn am-round\">\n" +
                    "</div></span></em>\n" +
                    "<em class=\"s-name\">"+data.obj.integral+" 积分<span class=\"vip1\">\n" +
                    "<div class=\"s-prestige am-btn am-round\">\n" +
                    "</div></span></em>")
            })

			doData("sjyh_order/getstatus",userobj,function (data) {
			    for(var i =0;i<data.obj.length;i++){
			        if (data.obj[i].status=="待发货"){
					$("#huonumber1").html(data.obj[i].count);

					}else if(data.obj[i].status=="待收货"){
			            $("#huonumber2").html(data.obj[i].count);
					}
					else if(data.obj[i].status=="待退款"){
			            $("#huonumber4").html(data.obj[i].count);
					}
				}
            })

			doData("sjyh_order/getstatus2",userobj,function (data) {

                for(var i =0;i<data.obj.length;i++) {
                    if (data.obj[i].evalustatus == "待评价") {
                        $("#huonumber3").html(data.obj[i].count);
                    }
                }
            })


		doData("sjyh_order/fandorder",userobj,function (data) {

		    for (var i=0;i<2;i++) {
		        data.obj[i].shiptime=Date.prototype.getLongDate(data.obj[i].shiptime)
                $("#dingdanul").append("<li class=\"lg-item\">\n" +
                    "<div class=\"item-info\">\n" +
                    "<a href=\"../simple_product.jsp?comid=" + data.obj[i].c_id+"&type=2\">\n" +
                    "<img src=\"<%=basePath%>/uploadfiles/"+data.obj[i].styleImage+"\">\n" +
                    "</a>\n" +
                    "\n" +
                    "</div>\n" +
                    "<div class=\"lg-info\">\n" +
                    "\n" +
                    "<p>快件已从 "+data.obj[i].senderaddress+" 发出</p>\n" +
                    "<time>"+data.obj[i].shiptime+"</time>\n" +
                    "\n" +
                    "<div class=\"lg-detail-wrap\">\n" +
                    "<a class=\"lg-detail i-tip-trigger\" href=\"<%=basePath%>/liyi_sj/stage/logistics2.jsp?orderid="+data.obj[i].id+"\">查看物流明细</a>\n" +
                    "\n" +
                    "</div>\n" +
                    "\n" +
                    "</div>\n" +
			...
			//查询热销店铺;
		doData("sj_store/getmenewstore",userobj,function (data) {
		    $("#commxinpin").append("<a class=\"shop-info\" href=\"../shop.jsp?storeid="+data.obj[0].id+"\" target=\"_blank\">\n" +
                "<div class=\"face-img-panel\">\n" +
                "<img src=\"<%=basePath%>/uploadfiles/"+data.obj[0].storeimage+"\" alt=\"\">\n" +
                "</div>\n" +
                "<span class=\"shop-title\">"+data.obj[0].storename+"</span>\n" +
                "</a>\n" +
                "<a class=\"follow\" onclick='collectbtn("+data.obj[0].id+")' target=\"_blank\">收藏</a>")
        })
			...
			doData("sj_commodity/getcomm",model1,function (data) {
			    for (var i=0;i<data.obj.length;i++) {
			       ...
			       data.obj[i].price= (data.obj[i].price).toFixed(2);
			        $("#remai").append("<div class=\"new-goods-info\">\n" +
                        "<a class=\"shop-info\" href=\"../simple_product.jsp?comid="+data.obj[i].comid+"&type=2\" target=\"_blank\">\n" +
                        "<div >\n" +
                        "<img src=\"<%=basePath%>/uploadfiles/"+data.obj[i].image1+"\">\n" +
                        "</div>\n" +
                        "<span class=\"one-hot-goods\">￥"+data.obj[i].price+"</span>\n" +
                        "</a>\n" +
                        "</div>");
				}
